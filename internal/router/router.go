...
type StreamHandlerFunc func(*protocol.Request, *tcp.TCPConn) error
...
func (r *Router) RouteStream(req *protocol.Request, conn *tcp.TCPConn) error {
	if r.streamHandler != nil {
		return r.streamHandler(req, conn)
	}
